...
[![CI](https://img.shields.io/github/actions/workflow/status/TradableApp/simple-tokenized-ai-agent/ci.yml?branch=main&label=CI)](https://github.com/TradableApp/simple-tokenized-ai-agent/actions/workflows/ci.yml)
